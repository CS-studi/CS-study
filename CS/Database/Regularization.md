...
특정 어트리뷰트가 `결정자` 인 둘 이상의 전체 어트리뷰트 조합에는 함수 종속성을 만족하지만, 결정자의 어떤 일부 어트리뷰트에도 함수 종속이 아닌 경우를 말한다. 
...
특정 어트리뷰트가 `결정자` 인 둘 이상의 전체 어트리뷰트 조합에도 함수 종속이면서, 결정자의 일부 어트리뷰트에도 함수 종속인 경우를 말한다.
