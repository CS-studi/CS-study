...
3. Bounded Waiting(한정 대기) - 그 어떤 프로세스도 critical region에 들어가기 위해 영원히 기다려서는 안된다.
...
- 상호 배제를 위한 데이터 및 프로그램 모듈, 운영체제 내부의 프로그램을 모니터라고 한다.
...
- 뮤텍스는 운영체제 커널에 의해 제공된다.
    - kernel에 접근하기 때문에 system call을 이용함. 그래서 느리다.
